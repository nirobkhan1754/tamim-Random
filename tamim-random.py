#Tools Created By Nasrullah Tamim
# IT'S FREE TOOLS
...
print("\033[0;91mThis Tool's Free Nasrullah Tamim")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Nasrullah Tamim'
    print '\033[0;94mFACEBOOK : devil.12456'
    print '\033[0;96mGITHUB   : Nasrullah Tamim'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;91m [TAMIM CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
